class ArtifactsController < ApplicationController
  ...
  def artifact_image
    ...
    if (params[:project_id].to_i) == artifact.project_id
      @artifact_founded = artifact.key
    else
      render plain: "No image found"
    end
  end
  ...
  private
    ...
    def artifact_params
      params.require(:artifact).permit(:name, :project_id, :key)
    end
end
